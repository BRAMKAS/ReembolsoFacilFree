...
public class HttpNormalImpl {
	...
	public final byte[] downloadImagem(String url) {
		...
		try {
			...
			Log
					.i(CATEGORIA, "imagem retornada com: " + bytes.length
							+ " bytes");
	...
	// Faz um requsicaoo POST na URL informada e retorna o texto
	// Os parametros sao enviados ao servidor
	...
	private String getQueryString(Map<String, String> params) throws IOException {
